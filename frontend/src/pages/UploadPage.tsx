...
export const UploadPage: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="rounded-2xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-sm transition-colors">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500 dark:text-slate-400">
              Assign uploaded papers to a specific topic collection or leave as Default Workspace.
            </p>
          </div>
        </div>
          ...
          {!showNewCollection ? (
            <div className="flex items-center gap-2 w-full md:w-auto">
              <select
                ...
                className="bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-xl px-3 py-2 text-xs text-slate-800 dark:text-slate-200 focus:outline-none focus:border-brand-500 font-medium"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 text-xs font-semibold border border-slate-200 dark:border-slate-700 transition-colors whitespace-nowrap"
              >
            ...
            <form onSubmit={handleCreateCollection} className="flex items-center gap-2 w-full md:w-auto">
              <input
                type="text"
                placeholder="e.g. LLM Reasoning Papers"
                value={newCollectionName}
                onChange={(e) => setNewCollectionName(e.target.value)}
                className="bg-white dark:bg-slate-950 border border-brand-500 rounded-xl px-3 py-2 text-xs text-slate-900 dark:text-slate-100 focus:outline-none placeholder-slate-400"
                autoFocus
              />
              <button
                type="submit"
                className="px-3.5 py-2 rounded-xl bg-brand-500 text-slate-950 text-xs font-bold hover:bg-brand-400 shadow-sm transition-colors"
              >
                Create
              </button>
              <button
                ...
                className="px-2.5 py-2 text-xs text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-200 transition-colors"
              >
                Cancel
              </button>
            </form>
