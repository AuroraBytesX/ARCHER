    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="rounded-2xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-sm transition-colors">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="text-xs font-semibold text-slate-800 dark:text-slate-200">Target Collection (Optional)</h4>
            <p className="text-[11px] text-slate-500 dark:text-slate-400">Organize ingested papers by laboratory, conference, or project.</p>
          </div>
        </div>
          ...
          {!showNewCollection ? (
            <>
              <select
                ...
                className="bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-lg px-3 py-1.5 text-xs text-slate-800 dark:text-slate-200 focus:outline-none focus:border-brand-500"
              >
              ...
              <button
                ...
                className="p-1.5 rounded-lg bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-colors"
            ...
            <form onSubmit={handleCreateCollection} className="flex items-center gap-2">
              <input
                ...
                className="bg-white dark:bg-slate-950 border border-brand-500 rounded-lg px-3 py-1.5 text-xs text-slate-900 dark:text-slate-200 focus:outline-none"
                autoFocus
              />
              <button
                type="submit"
                className="px-3 py-1.5 rounded-lg bg-brand-500 text-slate-950 text-xs font-semibold hover:bg-brand-400"
              >
                Save
              </button>
              <button
                ...
                className="px-2 py-1.5 text-xs text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-200"
              >
                Cancel
              </button>
            </form>
